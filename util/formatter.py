...
def print_disclaimer():
    ...
    print("I am also not responsible for your financial decisions. I am not advising anyone to sell or buy Crypto Currencies and encourage everyone to do your own research. Participate at your own risk.\n")

def print_state_of_the_crypto(market_info, market_dom, fear_and_greed):
    ...
    print_market_dominance(market_dom, market_info)
...
def print_market_dominance(tickers, market_info):
    global_market_cap = float(market_info["quotes"]["USD"]["total_market_cap"])
    print("##MARKET DOMINANCE\n")

    for x in tickers:
        market_cap = float(x["quotes"]["USD"]["market_cap"])
        dominance_percentage = (market_cap / global_market_cap) * 100
        print("- **{}** (**{}**): **{:.2f}**%\n".format(x["name"], x["symbol"], dominance_percentage))
